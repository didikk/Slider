package io.github.didikk.slider.library;
...
import io.github.didikk.slider.library.Animations.BaseAnimationInterface;
import io.github.didikk.slider.library.Indicators.PagerIndicator;
import io.github.didikk.slider.library.SliderTypes.BaseSliderView;
import io.github.didikk.slider.library.Transformers.AccordionTransformer;
import io.github.didikk.slider.library.Transformers.BackgroundToForegroundTransformer;
import io.github.didikk.slider.library.Transformers.BaseTransformer;
import io.github.didikk.slider.library.Transformers.CubeInTransformer;
import io.github.didikk.slider.library.Transformers.DefaultTransformer;
import io.github.didikk.slider.library.Transformers.DepthPageTransformer;
import io.github.didikk.slider.library.Transformers.FadeTransformer;
import io.github.didikk.slider.library.Transformers.FlipHorizontalTransformer;
import io.github.didikk.slider.library.Transformers.FlipPageViewTransformer;
import io.github.didikk.slider.library.Transformers.ForegroundToBackgroundTransformer;
import io.github.didikk.slider.library.Transformers.RotateDownTransformer;
import io.github.didikk.slider.library.Transformers.RotateUpTransformer;
import io.github.didikk.slider.library.Transformers.StackTransformer;
import io.github.didikk.slider.library.Transformers.TabletTransformer;
import io.github.didikk.slider.library.Transformers.ZoomInTransformer;
import io.github.didikk.slider.library.Transformers.ZoomOutSlideTransformer;
import io.github.didikk.slider.library.Transformers.ZoomOutTransformer;
import io.github.didikk.slider.library.Tricks.FixedSpeedScroller;
import io.github.didikk.slider.library.Tricks.InfinitePagerAdapter;
import io.github.didikk.slider.library.Tricks.InfiniteViewPager;
import io.github.didikk.slider.library.Tricks.ViewPagerEx;

/**
 * SliderLayout is compound layout. This is combined with {@link io.github.didikk.slider.library.Indicators.PagerIndicator}
 * and {@link io.github.didikk.slider.library.Tricks.ViewPagerEx} .
 *
...
public class SliderLayout extends RelativeLayout{
    ...
    /**
     * {@link io.github.didikk.slider.library.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link io.github.didikk.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link io.github.didikk.slider.library.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link io.github.didikk.slider.library.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link io.github.didikk.slider.library.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link io.github.didikk.slider.library.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link io.github.didikk.slider.library.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link io.github.didikk.slider.library.Tricks.ViewPagerEx} 's transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see io.github.didikk.slider.library.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link io.github.didikk.slider.library.Indicators.PagerIndicator} shape, rect or oval.
     */
     ...
     * {@link io.github.didikk.slider.library.Animations.BaseAnimationInterface},
     * and you can see a example in {@link io.github.didikk.slider.library.Animations.DescriptionAnimation}
     * @param animation
     */
    ...
    /**
     * get the {@link io.github.didikk.slider.library.Indicators.PagerIndicator} instance.
