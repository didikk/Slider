package io.github.didikk.slider.library.Transformers;
 ...
 *
 * BaseTransformer implement {@link io.github.didikk.slider.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link io.github.didikk.slider.library.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link io.github.didikk.slider.library.Animations.BaseAnimationInterface}
 * work.
 *
